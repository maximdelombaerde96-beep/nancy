...
import { berekenAvi, parseToetsmoment, type AviNorm } from "./avi";

// ============================================================================
//  Herbruikbare seed-logica (enkel INSERTS — verwijdert nooit iets).
//  Wordt gebruikt door:
//   - prisma/seed.ts  (lokaal script; wist eerst en seedt dan)
//   - /api/admin/seed (productie; weigert als er al leerlingen zijn)
// ============================================================================
...
function maakAvi(toetsmoment: string, datum: Date, leestijd: number, fouten: number) {
  ...
  return { toetsmoment, datum, leestijdSeconden: leestijd, fouten, aviNiveau, status };
}
...
const leerlingenData: LeerlingSeed[] = [
  // ---- Klas 3A (leerjaar 3) ----
  {
    voornaam: "Emma",
    achternaam: "Peeters",
    ...
    leerjaar: 3,
    status: "geen",
    avi: [{ moment: "M3", datum: "2026-01-15", leestijd: 120, fouten: 3 }],
  },
  {
    voornaam: "Noah",
    achternaam: "Janssens",
    ...
    avi: [{ moment: "M3", datum: "2026-01-15", leestijd: 200, fouten: 10 }],
  },
  {
    voornaam: "Olivia",
    achternaam: "Maes",
    ...
    leerjaar: 3,
    status: "geen",
    avi: [{ moment: "M3", datum: "2026-01-15", leestijd: 95, fouten: 1 }],
  },
  {
    voornaam: "Lucas",
    achternaam: "Willems",
    ...
    zorgprofiel: {
      ...
      zorgmaatregelen:
        "Wekelijkse leessessies met leersteuncoach. Gebruik van leeslineaal.",
      diagnoses: [
        { type: "Dyslexie (vermoeden)", datum: "2025-11-10", bron: "CLB" },
      ],
    },
    avi: [{ moment: "M3", datum: "2026-01-15", leestijd: 240, fouten: 14 }],
  },
  {
    voornaam: "Mila",
    achternaam: "Claes",
    ...
    leerjaar: 3,
    status: "geen",
    avi: [{ moment: "M3", datum: "2026-01-15", leestijd: 150, fouten: 5 }],
  },
  {
    voornaam: "Finn",
    achternaam: "Wouters",
    ...
    avi: [{ moment: "M3", datum: "2026-01-15", leestijd: 185, fouten: 9 }],
  },
  ...
  },
  {
    ...
    zorgprofiel: {
      ...
      diagnoses: [
        {
          type: "Taalontwikkelingsstoornis (TOS)",
          datum: "2023-05-18",
          bron: "Logopedist",
        },
      ],
  ...
  },
  {
    ...
    zorgprofiel: {
      ...
      diagnoses: [
        { type: "Leesachterstand", datum: "2025-09-30", bron: "Zorgcoördinator" },
      ],
    },
    avi: [
...
// Vult de database met fictieve testdata. Verwijdert NIETS.
export async function seedDatabase(prisma: PrismaClient): Promise<SeedResult> {
  ...
  // Opvolgacties met datums relatief aan "vandaag" (verlopen/binnenkort/later).
  ...
  return {
    klassen: 2,
    leerlingen: leerlingenData.length,
